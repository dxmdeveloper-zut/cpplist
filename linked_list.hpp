...
struct llist_node_t {
    ...
    llist_node_t(T data) { this->data = data; }
};
...
template<class T>
linked_list<T>::~linked_list() { this->clear(); }
...
template<class T>
void linked_list<T>::pop_back() { _pop_back_or_front(false); }

template<class T>
void linked_list<T>::pop_front() { _pop_back_or_front(true); }
